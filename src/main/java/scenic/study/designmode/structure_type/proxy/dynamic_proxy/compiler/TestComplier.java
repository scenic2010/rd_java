package scenic.study.designmode.structure_type.proxy.dynamic_proxy.compiler;
...
public class TestComplier {
	...
	public static void main(String[] args) throws Exception
	{
		...
		Constructor ctr = classz.getConstructor(scenic.study.designmode.structure_type.proxy.dynamic_proxy.Moveable.class);
		scenic.study.designmode.structure_type.proxy.dynamic_proxy.Moveable m = (scenic.study.designmode.structure_type.proxy.dynamic_proxy.Moveable) ctr.newInstance(new scenic.study.designmode.structure_type.proxy.dynamic_proxy.Tank());
		m.move();
	}
}
