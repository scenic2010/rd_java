...
import scenic.study.designmode.behaviour_type.visitor.man_woman_example.solution3.core.Visitor;
...
public class Execute {
    ...
    public Execute(){
        persons.add(new Man());
        persons.add(new scenic.study.designmode.behaviour_type.visitor.man_woman_example.solution3.Woman());
    }
